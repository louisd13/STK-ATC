...
protected:
    ...
    /** Sound used to denote when the current player overtakes. */
    SFXBase *m_happy_horn;
    /** Sound used to denote when the current player is overtaken. */
    SFXBase *m_sad_horn;
    //////////
    ...
    float computeRelativeAngle(float a, float b);
